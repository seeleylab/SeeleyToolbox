...
firstlevel_root=regexprep(fileparts(which('firstlevel_process_MASTER_cmd.m')),'/proc','');
...
% fMRI specifications
TR=2; % this should be a vector with each subject's TR
...
mask_threshold=true;% if false, look at all voxels; if true, look at top 20% intensity voxels
