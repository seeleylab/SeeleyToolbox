...
%slice_order=[1:37];
smooth_fwhm=[6 6 6]; % kernel size in mm for x,y,z
...
if realign
    ...
    % create merged 4d functional file
    merge='';
    for n=1:n_scans
...
%% 4.5 File preparation for coregistration
merged_file=sprintf('%s/%s/%s_merged',rspth,interfmri_imgs_dir,base_filename);

% split and rename files
addstr=strcat(addstr_ica,'ua');
cmd=sprintf('fslsplit %s %s/%s%s_ -t',merged_file,interfmri_imgs_dir_fullpth,addstr,base_filename);
fsl_matlab(cmd,false);
for n=1:n_scans
